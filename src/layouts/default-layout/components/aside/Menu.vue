<!-- Menu.vue -->
<template>
    <div id="#kt_aside_menu_wrapper" ref="scrollElRef" data-kt-scroll="true" data-kt-scroll-height="auto"
        data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}"
        data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px" data-kt-menu="true"
        ...
        <div id="#kt_aside_menu"
            ...
            <div data-kt-menu-trigger="click" class="menu-item  menu-accordion "
                :class="{ 'hover show': isPrimaryRouteActive('dashboard') }">
                <span class="menu-link">
                    ...
                    <span :class="[
                        { 'd-none': !isHovered && asideWidth === '90px' },
                        { 'd-flex': isHovered },
                    ]" class="menu-arrow menu-title-transition"></span>
                </span>
                <div class="menu-sub menu-sub-accordion menu-title-transition"
                    ...
                    <div class="menu-item">
                        ...
                        <div class="menu-link " :class="{ 'active shadow-sm': isRouteActive('/dashboard') }">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title overflow-hidden">
                                <router-link to="/dashboard" class="link-dark"
                                    :class="{ 'link-primery': isRouteActive('/dashboard') }">Default</router-link>
                            </span>
                        </div>
                    </div>
                    <div class="menu-item">
                    ...
                    <div class="menu-inner flex-column collapse" id="kt_app_sidebar_menu_dashboards_collapse" style="">
                        <div class="menu-item">
                            <a class="menu-link" href="#"
                                v-tooltip:top="`You still brought your cursor here... but this is to show you that this is something we can do with the sidebar`">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-item" bis_skin_checked="1">
                        <div class="menu-content" bis_skin_checked="1">
                            <a class="btn btn-flex btn-color-primary d-flex flex-stack fs-base p-0 ms-2 mb-2 toggle collapsible collapsed"
                                ...
                                data-kt-toggle-text="Show Less" aria-expanded="false">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion"
                :class="{ 'hover show': isPrimaryRouteActive('transactions') }">
                <span class="menu-link">
                ...
                <div class="menu-sub menu-sub-accordion menu-title-transition"
                    ...
                    <div class="menu-item">
                        <!-- Use RouterLink with active-class for dynamic styling -->
                        <div class="menu-link" :class="{ 'active shadow-sm': isRouteActive('/products') }">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title menu-title-transition overflow-hidden">
                                <router-link to="/products" class="link-dark"
                                    :class="{ 'link-primery': isRouteActive('/products') }">Products</router-link>
                            </span>
                        </div>
                    </div>
                    <div class="menu-item">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion "
                :class="{ 'hover show': isPrimaryRouteActive('configuration') }">
                <span class="menu-link">
                    <div class="menu-icon mx-2">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion "
                :class="{ 'hover show': isPrimaryRouteActive('accounts') }">
                <span class="menu-link" >
                    <div class="menu-icon mx-2">
                ...
                <div class="menu-sub menu-sub-accordion menu-title-transition"
                    ...
                    <div class="menu-item">
                        <!-- Use RouterLink with active-class for dynamic styling -->
                        <router-link to="/accounts/account_information" class="menu-link"
                            :class="{ 'active shadow-sm': isRouteActive('/accounts/account_information') }">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title overflow-hidden">
                                <span class="link-dark"
                                    :class="{ 'link-primery': isRouteActive('/accounts/account_information') }">Account
                                    Information</span>
                            </span>
                        </router-link>
                    </div>
                    ...
                    <div class="menu-item">
                        <router-link to="/accounts" class="menu-link" :class="{ 'active shadow-sm': isRouteActive('/accounts') }">
                            ...
                            <span class="menu-title overflow-hidden">
                                <span class="link-dark" :class="{ 'link-primery': isRouteActive('/accounts') }">Related
                                    Accounts</span>
                            </span>
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion "
                :class="{ 'hover show': isPrimaryRouteActive('users') }">
                <span class="menu-link">
                    <div class="menu-icon mx-2">
